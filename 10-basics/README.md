...
cd containerlab-workshop-ch-uni/10-basics
```

The repo should be cloned and you should be in the `containerlab-workshop-ch-uni` directory as per the output below:

```
[*]─[vm4]─[~/containerlab-workshop-ch-uni/10-basics]
└──>
```
...
```bash
[*]─[vm4]─[~/containerlab-workshop-ch-uni/10-basics]
└──> containerlab inspect -t ~/containerlab-workshop-ch-uni/10-basics/
